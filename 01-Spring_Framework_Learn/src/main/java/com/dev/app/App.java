...
import com.dev.app.model.CacheManager;
...
//        car.drive();
        ...
        CacheManager cacheObj = context.getBean(CacheManager.class); 
        System.out.println(cacheObj);
        CacheManager cacheObj2 = context.getBean(CacheManager.class); 
        System.out.println(cacheObj2);
